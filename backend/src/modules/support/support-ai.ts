...
export const NO_ANSWER_PHRASE =
  'Мне нужно уточнить это у коллег — подключаю старшего специалиста, он продолжит здесь же. Повторять ничего не нужно.';
...
export const MAYBE_SUFFIX =
  '\n\nЕсли не поможет — напишите мне, подключу старшего специалиста.';
