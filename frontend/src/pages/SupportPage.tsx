      ...
      <div className="support-page">
        ...
        */}
        <div className="support-state">
          ...
          <p className="dim">
            Поддержка — живой разговор внутри CRM: специалист первой линии видит, на
            каком вы экране, и знает систему по справочнику ANTHILL. Не помог — одна
            кнопка, и подключится старший специалист. Контекст при этом не теряется,
