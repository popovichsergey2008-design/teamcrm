        ...
        */}
        <div className="support-block">
          ...
          <p className="dim">
            ...
            в пределах ваших прав и говорит, из какого раздела взят ответ. Справочник едет
            вместе с системой: после обновления CRM изменившиеся разделы перезагружаются сами.
          </p>
          {hb && (
            <>
